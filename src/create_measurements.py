...
def build_weather_station_name_list():
    ...
    """
    station_names = []
    with open('C:/Users/Rahel Gasser/Desktop/D/Python/1brc/data/weather_stations.csv', 'r', encoding="utf8") as file:
...
def build_test_data(weather_station_names, num_rows_to_create):
    ...
    try:
        with open("D:/D/Python/data/measurements.txt", 'w', encoding="utf-8") as file:
            progress = 0
    ...
    file_size = os.path.getsize("D:/D/Python/data/measurements.txt")
    human_file_size = convert_bytes(file_size)
 
    print("Test data successfully written to D:/D/Python/data/measurements.txt")
